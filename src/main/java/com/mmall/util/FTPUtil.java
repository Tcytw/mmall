...
public class FTPUtil {
    ...
    private static final String ftpRemotePath = PropertiesUtil.getProperty("ftp.source");
    ...
    public static boolean uploadFile(List<File> fileList) throws IOException {
        FTPUtil ftpUtil = new FTPUtil(ftpIp, ftpuser, ftpPwd, 21);
        logger.info("开始连接FTP服务器");
        boolean result = ftpUtil.uploadFile(ftpRemotePath, fileList);
